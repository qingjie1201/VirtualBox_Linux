...
$ docker ps -a  查看所有docker容器，包括启动的和未启动的

$ docker run [xxx] [--help]  建立并启动docker容器

$ docker start [id/name]  启动docker容器

$ docker stop [id/name]  停止docker容器

$ docker rm [id/name]  删除docker容器
